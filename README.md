...
3. Примените миграции командой ```sudo docker exec -ti car_loan_php php bin/console d:m:m```
4. Примените фикстуры командой ```sudo docker exec -ti car_loan_php php bin/console doctrine:fixtures:load```
